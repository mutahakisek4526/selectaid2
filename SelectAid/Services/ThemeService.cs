...
public class ThemeService
{
    ...
    public void ApplyTheme(string themeId)
    {
        ...
        var themeDict = app.Resources.MergedDictionaries.FirstOrDefault(d => d.Source != null && d.Source.OriginalString.Contains("Theme/") && !d.Source.OriginalString.Contains("Base.xaml"));
        if (themeDict != null)
        {
